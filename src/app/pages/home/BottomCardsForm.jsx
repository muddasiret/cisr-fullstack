...
const BottomcardsForm = ({
  ...
  const [itemId, setItemId] = useState(
    defaultValues.id ? defaultValues.id : bottomcardsLength + 1
  );
  ...
  async function submitForm() {
    ...
    if (Object.keys(defaultValues).length !== 0) {
      res = await axiosInstance.put("/api/bottomcards-update", {
        ...defaultValues,
        ...editedValues,
      });
    } else {
      res = await axiosInstance.post("/api/bottomcards-update", {
        ...defaultValues,
        ...editedValues,
      });
    }
    if (res?.data) {
      setBottomcards(res.data.allBottomcards);
      handleCancel();
    }
  }
...
export default React.memo(BottomcardsForm);

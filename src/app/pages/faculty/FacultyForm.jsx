...
const FacultyForm = ({
  ...
  const [itemId, setItemId] = useState(
    defaultValues.id ? defaultValues.id : facultyLength + 1
  );
  ...
  async function submitForm() {
    ...
    if (Object.keys(defaultValues).length !== 0) {
      res = await axiosInstance.put("/api/faculty-update", {
        ...defaultValues,
        ...editedValues,
      });
    } else {
      res = await axiosInstance.post("/api/faculty-update", {
        ...defaultValues,
        ...editedValues,
      });
    }

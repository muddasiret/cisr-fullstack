...
const FacultyForm = lazy(() => import("./FacultyForm"));
...
const Faculty = () => {
  ...
  function showDeleteModal(faculty) {
    setIsDeleteModalOpen(faculty);
  }

  function deleteFaculty() {
    setIsDeleting(true);
    axiosInstance
      .post("/api/faculty-delete", isDeleteModalOpen)
      .then((response) => {
